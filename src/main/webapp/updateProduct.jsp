                        ...
                        <div class="single-products">
                            <div class="productinfo text-center">
                                <div class="signup-form1" style="margin: auto">
                                    <form class="form-inline" action="AdminEditProduct" method="post" enctype="multipart/form-data">
                                        <table style="padding-left: 30px">
                                            ...
                                            <tr>
                                                <td>Product Price : </td>
                                                <td>
                                                    <input type="number" name="price" placeholder="Price" style="width: 100%"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="quantity" placeholder="Quantity" style="width: 100%"
                                            ...
                                            <tr>
                                                <td>Update Image : </td>
                                                <td>
                                                    <input type="file" id="inpFile" name="photo" placeholder="choose image" style="width: 100%"
                                                           required="true" >
                                                </td>
                                            </tr>
                                            <tr>
